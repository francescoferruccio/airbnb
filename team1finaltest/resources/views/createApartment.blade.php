              ...
              <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                      <input id="rooms" min="1" max="50" type="number" class="stileForm @error('rooms') is-invalid @enderror" name="rooms" value="{{ old('rooms') }}" autocomplete="rooms" placeholder="1" autofocus>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <input id="beds" min="1" max="50" type="number" class="stileForm @error('beds') is-invalid @enderror" name="beds" value="{{ old('beds') }}" autocomplete="beds" placeholder="1" autofocus>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-6">
                          <input id="bathrooms" min="1" max="50" type="number" class="stileForm @error('bathrooms') is-invalid @enderror" name="bathrooms" value="{{ old('bathrooms') }}" autocomplete="bathrooms" placeholder="1" autofocus>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <input id="size" min="1" max="2000" type="number" class="stileForm @error('size') is-invalid @enderror" name="size" value="{{ old('size') }}" autocomplete="size" autofocus>
